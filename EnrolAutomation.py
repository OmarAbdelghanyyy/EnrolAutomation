...
name_box = driver.find_element(By.NAME, "loginfmt")  # finds login text box
name_box.send_keys(UNIVERSITY_lOGIN)  # inputs login
...
password_box.send_keys(UNIVERSTIY_PASSWORD)  # inputs Password
...
driver.get("https://www.uocampus.uottawa.ca/psc/csprpr9www/EMPLOYEE/SA/c/SA_LEARNER_SERVICES.SSR_SSENRL_LIST.GBL?Page"
           "=SSR_SSENRL_LIST&Action=A&ACAD_CAREER=CAR&EMPLID=STUDENTID&ENRL_REQUEST_ID=&INSTITUTION=INST&STRM=TERM")  # Redirects to My Class Schedule Page
